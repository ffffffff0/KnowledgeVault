...
def get_or_create_secret_key():
    ...
    configured_key = get_base_config("rag service", {}).get("secret_key")
...
def init_settings():
    ...
    try:
        ...
        logging.error(f"Failed to load llm_factories.json: {e}")
        FACTORY_LLM_INFOS = []
    ...
    HOST_IP = get_base_config(RAG_SERVICE_NAME, {}).get("host", "127.0.0.1")
    HOST_PORT = get_base_config(RAG_SERVICE_NAME, {}).get("http_port")
